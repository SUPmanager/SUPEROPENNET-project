...
define("POST_DELAY",9);
	...
	$errored = 1;
 	...
 	$nick = sessread($_SESSION['user']);
  	...
  	$success = "<p>글이 등록되었습니다!</p><p><a href=\"atalk.php\"><font color=\"0100FF\">방명록으로 돌아가기</font></a></p>";
	...
	//새로운코드입니다 - 스태프 권한(isStaff 를 따로 추가시킵니다. 글자수제한에 넣었기 때문에 다른사람들 닉을 추가할 수 없던 문제를 발견했습니다)
		if($nick=="DNA"||$nick=="HG"||$nick=="sisi"||$nick=="예비"|$nick=="소설"||$nick=="ECLIPSE"||$nick=="아론"||$nick=="bts"||$nick=="NKN"||$nick=="Lottemart_"||$nick=="롯데"||$nick=="extra_"||$nick=="흑룡!"||$nick=="Go3갈치"||$nick=="이기"||$nick=="Dr.Gaster"||$nick=="알파"||$nick=="Samsunglions_"){
			$isStaff = 1;
	...
	if($oldnick=="DNA"||$oldnick=="HG"||$oldnick=="sisi"||$oldnick=="예비"||$oldnick=="소설"||$oldnick=="ECLIPSE"||$oldnick=="아론"||$oldnick=="bts"||$oldnick=="NKN"||$oldnick=="Lottemart_"||$oldnick=="롯데"||$oldnick=="extra_"||$oldnick=="흑룡!"||$oldnick=="Go3갈치"||$oldnick=="이기"||$oldnick=="Dr.Gaster"||$oldnick=="알파"||$oldnick=="Samsunglions_"){
...
<p><input maxlength="6" name="ccode" size="6" type="text" value="'.$_SESSION['cc'].'"/></p>';
	...
	if($checker=="DNA"||$checker=="Samsunglions_"||$checker=="sisi"||$checker=="예비"||$checker=="소설"||$checker=="ECLIPSE"||$checker=="아론"||$checker=="bts"||$checker=="NKN"||$checker=="Lottemart_"||$checker=="롯데"||$checker=="extra_"||$checker=="흑룡!"||$checker=="Go3갈치"||$checker=="이기"||$checker=="Dr.Gaster"||$checker=="알파"){
