...
define("POST_DELAY",9);
	...
	$errored = 1;
 	...
 	$nick = sessread($_SESSION['user']);
  	...
  	$success = "<p>의견 감사합니다!</p><p><a href=\"HOStalk.php\"><font color=\"0100FF\">토론장으로 돌아가기</font></a></p>";
...
<p><font color="grey">누구든지 자유롭게 의견을 낼 수 있습니다. 하지만 주제에 맞지 않는 글은 자제해주십시오.</font></p>

<form action="ok.php" method="post">

<h2><font color=00fafa>의견</font></h2>
...
<p><font color=FAFA00><input type="submit" value="제출" /></font></p>
</form>';
