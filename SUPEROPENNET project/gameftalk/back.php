...
if(isset($_REQUEST['page'])){
	...
	$opage = $page;
		...
		if($page <= $npage){
		echo "<p><font color=339966>$page</font>번째 페이지입니다. (전체 <font color=orange>$npage</font>페이지)</p>";
		fclose($fp);
		$page = 1000 * ($page - 1);
		...
		echo '<p>페이지는 총 <font color="339966">'.$inde.'</font>페이지입니다.</p>';
		fclose($delta);
}
?>
<p></p>
