...
require '../define.php';
 session_start();
 	...
 	$time2 =date('i');
   	$intermsg = "[".$time2."분에 <font color=\"blue\">".$name."</font>님이 접속!]<hr />";
...
define("POST_DELAY",9);
	...
	$errored = 1;
 	...
 	$nick = sessread($_SESSION['user']);
  	...
  	$success = "<p>글이 등록되었습니다!</p><p><a href=\"btalk.php\"><font color=\"0100FF\">톡톡으로 돌아가기</font></a></p>";
	...
	//새로운코드입니다 - 스태프 권한(isStaff 를 따로 추가시킵니다. 글자수제한에 넣었기 때문에 다른사람들 닉을 추가할 수 없던 문제를 발견했습니다)
		if($nick=="DNA"||$nick=="예비"|$nick=="소설"||$nick=="ECLIPSE"||$nick=="아론"||$nick=="bts"||$nick=="KE"||$nick=="Lottemart_"||$nick=="롯데"||$nick=="extra_"||$nick=="흑룡!"||$nick=="Go3갈치"||$nick=="알파"||$nick=="Dr.Gaster"||$nick=="Samsunglions_"){
			$isStaff = 1;
	...
	if($oldnick=="DNA"||$oldnick=="HG"||$oldnick=="sisi"||$oldnick=="예비"||$oldnick=="소설"||$oldnick=="ECLIPSE"||$oldnick=="아론"||$oldnick=="bts"||$oldnick=="KE"||$oldnick=="Lottemart_"||$oldnick=="롯데"||$oldnick=="extra_"||$oldnick=="흑룡!"||$oldnick=="Go3갈치"||$oldnick=="알파"||$oldnick=="Dr.Gaster"||$oldnick=="Samsunglions_"){
	...
	$time =date('i');
   	$outputstr = "[".$time."분]".$nick."<br />[".$thing."]<hr />";	//구분자삽입
	...
	$_SESSION['dobe'] = 1;
$_SESSION['cc'] = $ccode;
		if($oldnick=="DNA"||$oldnick=="예비"||$oldnick=="소설"||$oldnick=="ECLIPSE"||$oldnick=="아론"||$oldnick=="bts"||$oldnick=="KE"||$oldnick=="Lottemart_"||$oldnick=="롯데"||$oldnick=="extra_"||$oldnick=="흑룡!"||$oldnick=="Go3갈치"||$oldnick=="알파"||$oldnick=="Dr.Gaster"||$oldnick=="Samsunglions_"){
		$_SESSION['mc'] = $mcode;
		}
	}
}
...
<p><font color="grey"><sup>* 표시는 글과 각종 코드들로 </sup><sub>채워넣으셔야 합니다!</sub></font></p>
...
<p><input maxlength="6" name="ccode" size="6" type="text" value="'.$_SESSION['cc'].'"/></p>';
	...
	if($checker=="DNA"||$checker=="예비"||$checker=="소설"||$checker=="ECLIPSE"||$checker=="아론"||$checker=="bts"||$checker=="KE"||$checker=="Lottemart_"||$checker=="롯데"||$checker=="extra_"||$checker=="흑룡!"||$checker=="Go3갈치"||$checker=="알파"||$checker=="Dr.Gaster"||$checker=="Samsunglions_"){
