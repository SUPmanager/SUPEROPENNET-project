...
<p>자유 롤 게시판 입니다.</p>
<p><a href="../gamebtalk/home.php">뒤로가기</a></p><p><font color="red">[공지] 소환사의 협곡에 오신 것을 환영합니다!</font></p>
...
<script language='php'>
	...
	if(!$wri){
	$errorp = "<p><font color=red>치명적인 에러 발생! 나중에 재시도해 주십시오!</font></p>"; //파일 안열림
	echo $errorp;//경고출력
	exit;//종료
	}
...
<p><?php if(!isset($_SESSION['user'])){ echo '<a href="../iden/login.php"><font color="Darkblue">로그인</font></a>'; }else{ echo '<a href="../iden/logout.php"><font color="Darkblue">로그아웃</font></a>'; } ?></font></a></p><p><a href="LoLtalk.php"><font color="darkRed">새로고침</font></a>
<?php
